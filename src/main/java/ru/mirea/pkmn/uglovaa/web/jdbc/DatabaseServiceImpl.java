...
public class DatabaseServiceImpl implements DatabaseService {
    ...
    public Student getStudentFromDatabase(String studentFullName) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            throw new RuntimeException("Error retrieving student from database", e);
        }
    }
    ...
    public void saveCardToDatabase(Card card) throws IOException {
        ...
        if (ownerUUID != null) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                ...
                if (rowsAffected > 0) System.out.println("Card data successfully added.");
            } catch (SQLException e) {
                throw new RuntimeException("Error adding card data", e);
            }
        } else {
    ...
    private UUID fetchOwnerUUID(String familyName) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            throw new RuntimeException("Error fetching owner UUID", e);
        }
    }
